...
liste_maxN = [6000] #list of integers, representing the number of excitatory neurons in the CA1 region
...
liste_g_max_e = [48*psiemens] #list of floats (in siemens), representing the maximum synaptic conductances of excitatory synapses
