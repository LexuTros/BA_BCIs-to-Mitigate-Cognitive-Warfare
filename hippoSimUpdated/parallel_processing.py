...
liste_maxN = [9000] #list of integers, representing the number of excitatory neurons in the CA1 region
...
liste_g_max_e = [57*psiemens] #list of floats (in siemens), representing the maximum synaptic conductances of excitatory synapses
...
liste_gCAN = [(0.5*usiemens*cmeter**-2, 5*usiemens*cmeter**-2)] #list of couples of the form (sleep CAN channel conductance, wakefulness CAN channel conductance), each value in siemens*meter**-2
liste_CAN = ['wake'] #list of strings ('wake' or 'sleep') to choose between sleep and wakefulness CAN channel conductances --- 'sleep' = gCAN[0], 'wake' = gCAN[1]
liste_G_ACh = [1.5] #list of floats, representing the gain applied on some synaptic conductances under cholinergic modulation --- ONLY APPLIED WHEN functional_co = 'wake'
liste_functional_co = ['wake']  #list of strings ('wake' or 'sleep') to choose between sleep and wakefulness functional connectivity --- ONLY decides if G_ACh has effect or not
...
#simulation duration
liste_runtime = [60*second, 60*second, 60*second, 60*second, 60*second, 60*second, 60*second, 60*second] #list of floats, representing the duration of the simulation (in second)
