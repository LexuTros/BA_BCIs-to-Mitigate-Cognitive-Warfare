...
liste_maxN = [7000] #list of integers, representing the number of excitatory neurons in the CA1 region
...
liste_gCAN = [(0.5*usiemens*cmeter**-2, 18*usiemens*cmeter**-2)] #list of couples of the form (sleep CAN channel conductance, wakefulness CAN channel conductance), each value in siemens*meter**-2
...
liste_G_ACh = [2.5] #list of floats, representing the gain applied on some synaptic conductances under cholinergic modulation --- ONLY APPLIED WHEN functional_co = 'wake'
