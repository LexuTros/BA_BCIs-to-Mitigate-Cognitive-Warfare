...
liste_functional_co = ['wake', 'wake', 'wake', 'wake', 'wake', 'wake', 'wake', 'wake']  #list of strings ('wake' or 'sleep') to choose between sleep and wakefulness functional connectivity --- ONLY decides if G_ACh has effect or not
